...
import datetime
import telnyx_processor as telnyx
from twilio_processor import Twilio
import ghl_processor as ghl
...
def sms_blaster(contacts_json_path: str):
    ...
    for i, contact in enumerate(contacts, start=1):
        ...
        if to_phone_number not in telnyx_sent_contacts:
            ...
            telnyx_sent_result = telnyx.send_telnyx_sms(to_phone_number, sms_message, telnyx_from_numbers[0])
