...
def add_outbound_message(ghl_conversation_id, message_text):
    """
    creates outbound Message in a Conversation for a provided Contact ID
    """
...
def modify_ghl_conversation(contact_id, sms_message):
    ...
    if get_conversation_response["success"] is True:
        ...
        return True if add_outbound_message(conversation_id, sms_message) is True else False
...
if __name__ == "__main__":
    ...
    pprint(get_conversations("Xz2gmG42honeq6DbkAk6"))

    # pprint(create_conversation("hXMgrfL6OMrR1Ocy8fKt"))

    # pprint(delete_conversation("JVSMOZyu0rCJpW3KtE1E"))

    # pprint(add_outbound_message("QHbe27TDuYU0tjBWlQnq", "test"))

    # pprint(modify_ghl_conversation("hXMgrfL6OMrR1Ocy8fKt", "test"))

    # pprint(set_ghl_sms_blast_status("hXMgrfL6OMrR1Ocy8fKt", "Success"))
    
    # pprint(send_sms_ghl("hXMgrfL6OMrR1Ocy8fKt", "test"))
